...
function(
  ...
  foreach(schema ${flatbuffers_schemas})
    ...
    if(NOT
      ...
      add_custom_command(
        ...
        COMMAND ${FLATC} ${FLATC_SCHEMA_ARGS} -o ${generated_includes_dir} ${include_params} -c ${schema}
    ...
    if(NOT
      ...
      add_custom_command(
        ...
        COMMAND ${FLATC} -b --schema -o ${binary_schemas_dir} ${include_params} ${schema}
        DEPENDS ${FLATC_TARGET} ${schema} ${additional_dependencies}
        WORKING_DIRECTORY "${working_dir}")
  ...
  # to be built.
  add_custom_target(${custom_target_name} DEPENDS ${all_generated_files} ${additional_dependencies})
  ...
  if(NOT
    ...
    set_property(TARGET ${custom_target_name} PROPERTY GENERATED_INCLUDES_DIR ${generated_includes_dir})
  endif()
  ...
  if(NOT
     ...
     STREQUAL
     "")
    set_property(TARGET ${custom_target_name} PROPERTY BINARY_SCHEMAS_DIR ${binary_schemas_dir})
  endif()
  ...
  if(NOT
     ...
     STREQUAL
     "")
    set_property(TARGET ${custom_target_name} PROPERTY COPY_TEXT_SCHEMAS_DIR ${copy_text_schemas_dir})
  endif()
endfunction()
...
function(flatbuffers_generate_headers)
  ...
  foreach(schema ${FLATBUFFERS_GENERATE_HEADERS_SCHEMAS})
    ...
    add_custom_command(
      ...
      COMMAND ${FLATC} ${FLATC_ARGS} -o ${generated_include_dir} ${include_params} -c ${schema}
              ${FLATBUFFERS_GENERATE_HEADERS_FLAGS}
    ...
    if(NOT
       ${FLATBUFFERS_GENERATE_HEADERS_BINARY_SCHEMAS_DIR}
       STREQUAL
       "")
      set(binary_schema "${FLATBUFFERS_GENERATE_HEADERS_BINARY_SCHEMAS_DIR}/${filename}.bfbs")
      add_custom_command(
        OUTPUT ${binary_schema}
        COMMAND ${FLATC} -b --schema -o ${FLATBUFFERS_GENERATE_HEADERS_BINARY_SCHEMAS_DIR} ${include_params} ${schema}
        DEPENDS ${FLATC_TARGET} ${schema}
        WORKING_DIRECTORY "${working_dir}")
  ...
  target_sources(
    ...
    INTERFACE ${all_generated_header_files}
              ${all_generated_binary_files}
              ${all_generated_source_files}
              ${FLATBUFFERS_GENERATE_HEADERS_SCHEMAS})
  add_dependencies(${FLATBUFFERS_GENERATE_HEADERS_TARGET} ${FLATC} ${FLATBUFFERS_GENERATE_HEADERS_SCHEMAS})
  target_include_directories(${FLATBUFFERS_GENERATE_HEADERS_TARGET} INTERFACE ${generated_target_dir})
...
function(flatbuffers_generate_binary_files)
  ...
  foreach(json_file ${FLATBUFFERS_GENERATE_BINARY_FILES_JSON_FILES})
    ...
    add_custom_command(
      ...
      COMMAND ${FLATC} ${FLATC_ARGS} -o ${FLATBUFFERS_GENERATE_BINARY_FILES_OUTPUT_DIR} ${include_params} -b
              ${FLATBUFFERS_GENERATE_BINARY_FILES_SCHEMA} ${json_file} ${FLATBUFFERS_GENERATE_BINARY_FILES_FLAGS}
  ...
  target_sources(
    ...
    INTERFACE ${all_generated_binary_files} ${FLATBUFFERS_GENERATE_BINARY_FILES_JSON_FILES}
